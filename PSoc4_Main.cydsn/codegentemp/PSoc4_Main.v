...
module top ;
    ...
    UART_v2_30_3 BLUE (
        ...
        .reset(1'b0),
        .rx(Net_397),
        .tx_interrupt(Net_420),
        .rx_interrupt(Net_421),
        .tx_data(Net_422),
        .tx_clk(Net_423),
        .rx_data(Net_424),
        .rx_clk(Net_425));
