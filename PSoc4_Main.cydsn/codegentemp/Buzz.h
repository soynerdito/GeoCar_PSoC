...
#define Buzz_DM_ALG_HIZ         (0x00u << Buzz_DRIVE_MODE_SHIFT)
#define Buzz_DM_DIG_HIZ         (0x01u << Buzz_DRIVE_MODE_SHIFT)
#define Buzz_DM_RES_UP          (0x02u << Buzz_DRIVE_MODE_SHIFT)
#define Buzz_DM_RES_DWN         (0x03u << Buzz_DRIVE_MODE_SHIFT)
#define Buzz_DM_OD_LO           (0x04u << Buzz_DRIVE_MODE_SHIFT)
#define Buzz_DM_OD_HI           (0x05u << Buzz_DRIVE_MODE_SHIFT)
#define Buzz_DM_STRONG          (0x06u << Buzz_DRIVE_MODE_SHIFT)
#define Buzz_DM_RES_UPDWN       (0x07u << Buzz_DRIVE_MODE_SHIFT)
