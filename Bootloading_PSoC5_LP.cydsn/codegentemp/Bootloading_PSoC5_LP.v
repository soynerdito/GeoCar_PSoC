...
module emFile_v1_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("a2177f87-e5ee-4fe6-bfb9-0cb592599151/ed092b9b-d398-4703-be89-cebf998501f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a2177f87-e5ee-4fe6-bfb9-0cb592599151/1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a2177f87-e5ee-4fe6-bfb9-0cb592599151/ae249072-87dc-41aa-9405-888517aefa28"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a2177f87-e5ee-4fe6-bfb9-0cb592599151/6df85302-e45f-45fb-97de-4bdf3128e07b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
    ...
    UART_v2_30_4 PSOC4 (
        ...
        .rx_data(Net_269),
        .rx_clk(Net_270));
    defparam PSOC4.Address1 = 0;
    defparam PSOC4.Address2 = 0;
    defparam PSOC4.EnIntRXInterrupt = 1;
    defparam PSOC4.EnIntTXInterrupt = 0;
    defparam PSOC4.FlowControl = 0;
    defparam PSOC4.HalfDuplexEn = 0;
    defparam PSOC4.HwTXEnSignal = 0;
    defparam PSOC4.NumDataBits = 8;
    defparam PSOC4.NumStopBits = 1;
    defparam PSOC4.ParityType = 0;
    defparam PSOC4.RXEnable = 1;
    defparam PSOC4.TXEnable = 1;
