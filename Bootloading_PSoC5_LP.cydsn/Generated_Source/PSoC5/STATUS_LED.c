...
{
    uint8 staticBits = (STATUS_LED_DR & (uint8)(~STATUS_LED_MASK));
    STATUS_LED_DR = staticBits | ((uint8)(value << STATUS_LED_SHIFT) & STATUS_LED_MASK);
}
...
{
	CyPins_SetPinDriveMode(STATUS_LED_0, mode);
}
...
{
    return (STATUS_LED_PS & STATUS_LED_MASK) >> STATUS_LED_SHIFT;
}
...
{
    return (STATUS_LED_DR & STATUS_LED_MASK) >> STATUS_LED_SHIFT;
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
        return (STATUS_LED_INTSTAT & STATUS_LED_MASK) >> STATUS_LED_SHIFT;
    }
