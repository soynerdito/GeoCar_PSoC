...
#define emFile_1_Clock_1_SetDivider(clkDivider)         emFile_1_Clock_1_SetDividerRegister(clkDivider, 1)
#define emFile_1_Clock_1_SetDividerValue(clkDivider)    emFile_1_Clock_1_SetDividerRegister((clkDivider) - 1, 1)
...
#define emFile_1_Clock_1_SetPhaseValue(clkPhase)        emFile_1_Clock_1_SetPhaseRegister((clkPhase) + 1)
#endif /* defined(emFile_1_Clock_1__CFG3) */
